package com.pall.doadzikirapp.model
...
object DataDoaDzikir {
    ...
    private val arabicDzikir = arrayOf(
    ...
    private val translateDzikir = arrayOf(
    ...
    fun listDzikirPagi(): List<DoaDzikirItem> {
        val listData = mutableListOf<DoaDzikirItem>()
        for (index in titleDzikirPagi.indices) {
            val data = DoaDzikirItem(
                titleDzikirPagi[index],
                arabicDzikirPagi[index],
                translateDzikirPagi[index]
            )
            listData.add(data)
        }
        return listData
    ...
    fun listDzikirPetang(): List<DoaDzikirItem> {
        val listData = mutableListOf<DoaDzikirItem>()
        for (index in titleDzikirPetang.indices) {
            val data = DoaDzikirItem(
                titleDzikirPetang[index],
                arabicDzikirPetang[index],
                translateDzikirPetang[index]
            )
            listData.add(data)
        }
        return listData
